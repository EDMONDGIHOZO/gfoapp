...
const Featured = () => {
    ...
    const [articles, setArticles] = useState([
        {
        id: 2,
        title: "The RBM Partnership to End Malaria has launched its 2021-2025 Strategic Plan",
        date: '25th mar'
        },{
        id: 3,
        title: "The RBM Partnership to End Malaria has launched its 2021-2025 Strategic Plan",
                ...
                <View style={GlobalStyles.cont}>
                    {
                        articles.map((article) => {
                            return (
                                <TouchableOpacity key={article.id.toString()} onPress={() => viewArticle(article.title)}>
